...
async function createOrderInSanity(
  ...
  const { orderNumber, customerName, customerEmail, clerkUserId, addressId } =
    metadata as unknown as Metadata & { addressId: string };
  const address = addressId ? await backendClient.getDocument(addressId) : null;
  ...
  const order = await backendClient.create({
    ...
    address: address
      ? {
          ...
          city: address.city === "other" ? address.customCity : address.city,
